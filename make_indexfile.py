...
leaf_entry5 = LeafEntry([1, 4, -5.0, 6.0])
leaf_entry6 = LeafEntry([1, 5, -4.0, 5.0])

leaf_entry7 = LeafEntry([1, 6, -1.0, -2.0])
leaf_entry8 = LeafEntry([1, 7, -1.0, 1.0])
leaf_entry9 = LeafEntry([1, 8, 1.0, -1.0])

leaf_entry10 = LeafEntry([1, 9, 0.0, -6.0])
leaf_entry11 = LeafEntry([1, 10, 2.0, -7.0])
leaf_entry12 = LeafEntry([1, 11, 3.0, -5.0])

leaf_entry13 = LeafEntry([1, 12, 5.0, -2.0])
leaf_entry14 = LeafEntry([1, 13, 5.0, 2.0])
leaf_entry15 = LeafEntry([1, 14, 7.0, 1.0])
...
internal_node2 = Node([entry3, entry4, entry5])
...
leaf_node1.set_parent(internal_node1, 0)
leaf_node2.set_parent(internal_node1, 1)
leaf_node3.set_parent(internal_node2, 0)
leaf_node4.set_parent(internal_node2, 1)
leaf_node5.set_parent(internal_node2, 2)
